...
<body>
    ...
    <section class="page-header header container-fluid">
        ...
        <div class="choixB">
            <div>
                <h1 class="titreCCC">Quel compte voulez-vous créer?</h1>
            </div><br>
            <div class="choix">
                <div><button><a class="choixV" href="InscriptionVendeur.php">Vendeur</a></button></div>
                <div><button><a class="choixA" href="InscriptionAcheteur.php">Acheteur</a></button></div>
            </div>
        </div>
        <br>
    </section>
