...
<html>
<head>
	<title>Meubles et Objets d'art</title>
	<meta charset="utf-8">
...
<body>
	...
	<section class="page-header header container-fluid">
		...
		<?php $produit = $DB->query('SELECT * FROM produit WHERE Categorie = "Meubles et objets d art" AND TypeVente = "Achat Immediat" '); ?>
		...
		<br>
		<?php endforeach ?>
		<?php $produit = $DB->query('SELECT * FROM produit WHERE Categorie = "Meubles et objets d art" AND TypeVente = "Enchere" '); ?>
		<?php foreach ($produit as $key => $produit): ?>
		<div class="pListeMO">
		...
		<br>
		<?php endforeach ?>
		<?php $produit = $DB->query('SELECT * FROM produit WHERE Categorie = "Meubles et objets d art" AND TypeVente = "Transaction Vendeur/Client" ' ); ?>
		<?php foreach ($produit as $key => $produit): ?>
		<div class="pListeMO">
